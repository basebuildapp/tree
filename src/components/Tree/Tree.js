...
var Tree = /** @class */ (function (_super) {
    ...
    function Tree() {
        ...
        _this.renderTreeItem = function (_a) {
            var flatItem = _a.flatItem, path = _a.path, provided = _a.provided, snapshot = _a.snapshot;
            var _b = _this.props, renderItem = _b.renderItem, onExpand = _b.onExpand, onCollapse = _b.onCollapse, offsetPerLevel = _b.offsetPerLevel;
            return (<TreeItem_1["default"] key={flatItem.item.id} item={flatItem.item} path={path} onExpand={onExpand} onCollapse={onCollapse} renderItem={renderItem} provided={provided} snapshot={snapshot} itemRef={_this.setItemRef} offsetPerLevel={offsetPerLevel}/>);
        };
        return _this;
    }
