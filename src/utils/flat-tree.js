...
var getFlatItemPath = function (flattenedTree, sourceIndex) { return flattenedTree[sourceIndex].path; };
...
/*
   ...
   */
var getDestinationPath = function (flattenedTree, sourceIndex, destinationIndex, 
...
var getItemById = function (flattenedTree, id) {
    return flattenedTree.find(function (item) { return item.item.id === id; });
};
exports.getItemById = getItemById;
var getIndexById = function (flattenedTree, id) { return flattenedTree.findIndex(function (item) { return item.item.id === id; }); };
